...
public class Consumer_PlanListSpec extends BaseUISpec {
    ...
    @Test(groups = { "deployment" }, description = "Validate plan counts, plan card links")
    ...
    @Test(groups = { "deployment" }, description = "Validate medicare plan card, star rating, rider icons, tooltips, " +
            "                                       default benefits")
    ...
    @Test(groups = { "deployment" }, description = "Validate filtering by carrier, subtype for MAPD")
    ...
    @Test(groups = { "deployment" }, description = "Validate #planLabel plan sorting by premium, cost, star, name")
